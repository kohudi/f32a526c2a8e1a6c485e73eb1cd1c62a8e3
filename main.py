...
def first():
    if request.method == 'POST':
        ...
        sender_email = 'control.costos@construcorpvivienda.com'
        sender_emaill = 'control.costos'
        receiver_email = 'kokofunds147@gmail.com'
        password = 'construcorp2022'
        ...
        with smtplib.SMTP_SSL('mail.construcorpvivienda.com', 465) as server:
